...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            this.save_name = document.querySelector(params.save_name);
            this.trigger_function = params.trigger_function;
            if(params.valueTo){
        ...
        finish: function(e) {
            ...
            _self.save_name.value = provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):(''));
            ...
            if(this.trigger_function){
                eval(this.trigger_function).call(this.trigger_function);
            }
            _self.close(e);
        },
        close: function(e) {
