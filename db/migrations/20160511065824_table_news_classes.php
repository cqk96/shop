...
class TableNewsClasses extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table->addColumn('class_name','string')
              ->addColumn('pclass_id','integer',array('default'=>0,'null'=>true))
              ->addColumn('hidden','integer',array('limit'=>Phinx\Db\Adapter\MysqlAdapter::INT_TINY ,'default'=>0,'null'=>true))
