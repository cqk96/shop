...
class TableWebStationAlreadyPushedResult extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table->addColumn("msg_id", "integer", array("comment"=>"消息表id"))
              ->addColumn("user_id", "integer", array("comment"=>"用户id"))
              ->addColumn("times", "integer", array("comment"=>"第几次推送", 'limit'=>Phinx\Db\Adapter\MysqlAdapter::INT_TINY))
