...
<div class="smart-widget">
	<div class="smart-widget-header">
		...
		<span class="smart-widget-option">
			<a href="/admin/sys/operate/create">
	...
	<tbody>
		...
		<tr class="<?php echo $i%2==0? 'singular':'dual' ?>">
			...
			<td class='operationBox' width='35%'>
				<a href="/admin/sys/operate/update?id=<?php echo $data[$i]['id']; ?>" ><span class="icon-img"><img src="/images/edit-icon.png" /></span>修改</a>
				<a href="/admin/sys/operate/doDelete?id=<?php echo $data[$i]['id']; ?>" onclick="return confirm('你确定要删除吗？')" ><span class="icon-img"><img src="/images/delete-icon.png" /></span>删除</a>
			</td>
		</tr>
		<?php } ?>
	</tbody>
...
$(document).ready(function(){
	...
	$('.deleteChooseBtn').click(function(){
		deleteChooseItems('ids','你确定要删除选定项吗？','/admin/sys/operate/destroy','true','showDeleteItems');
	});
});
</script>