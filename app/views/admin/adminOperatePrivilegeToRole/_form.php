...
<li class="list-group-item" draggable="false">
	...
	<label class="checkbox-inline">
	  <input type="checkbox" name="operate_ids[]" id="" value="<?php echo $privileges[$i]['id']; ?>" <?php if(!empty($rolePrivileges) && in_array($privileges[$i]['id'], $rolePrivileges)) echo "checked"; ?> > <?php echo $privileges[$i]['name']; ?>
	</label>
	<?php }?>
</li>
<li class="list-group-item" draggable="false">
