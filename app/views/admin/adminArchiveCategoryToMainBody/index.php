<?php include_once('../app/views/admin/_header.php') ?>
 ...
 <div class='smart-widget'>
	 <div class='smart-widget-header'>
		...
		<span class='smart-widget-option'>
			 <a href='/admin/archiveCategoryToMainBodys/create'>
		...
		<form class='searchForm' action='archiveCategoryToMainBodys' method='get'>
	 ...
	 <table id='indexTable' class=''>
		 <thead>
			 <tr class='firstLine'>
				 ...
				 <th>id</th>
				<th>archive_template_category_id</th>
				<th>main_body_type_id</th>
				<th>item_id</th>
				<th>create_time</th>
				<th>update_time</th>
		 ...
		 <tbody>
			 ...
			 <tr class='<?php echo $i%2==0? 'singular':'dual' ?>'>
				...
				<td><?php echo $data[$i]['archive_template_category_id'];?></td>
				<td><?php echo $data[$i]['main_body_type_id'];?></td>
				...
				<td><?php echo $data[$i]['update_time'];?></td>
				 ...
				 <td class='operationBox' colspan=2>
					 <a href='/admin/archiveCategoryToMainBodys/update?id=<?php echo $data[$i]['id']; ?>' ><span class='icon-img'><img src='/images/edit-icon.png' /></span>编辑</a>
					 <a type='button' href='/admin/archiveCategoryToMainBodys/doDelete?id=<?php echo $data[$i]['id']; ?>' onclick='return confirm("你确定要删除吗？")'><span class='icon-img'><img src='/images/delete-icon.png'></span>删除</a>
				 </td>
			 </tr>
			 <?php } ?>
		 </tbody>
		 <?php include_once('../app/views/admin/adminArchiveCategoryToMainBody/_tfoot.php') ?>
	 </table>
 </div><!-- ./smart-widget -->
 </div>
 ...
 $(document).ready(function(){
	 ...
	 $('.deleteChooseBtn').click(function(){
		 deleteChooseItems('eachNewsClassCheckBox','你确定要删除选定项吗？','/admin/archiveCategoryToMainBodys/destroy','','showDeleteItems','');
	 });
	//日期选择
