...
<div class="smart-widget">
	...
	<tbody>
		...
		<tr class="<?php echo $i%2==0? 'singular':'dual' ?>">
			...
			<td width='20%'> <?php echo $data[$i]['name']; ?> </td>
			<td width='30%'> <?php echo $data[$i]['description']; ?> </td>
			<td width='10%'> <?php echo $data[$i]['type_id']; ?> </td>
			<td class='operationBox' width='20%'>
				<a href="/admin/sys/role/update?id=<?php echo $data[$i]['id']; ?>" ><span class="icon-img"><img src="/images/edit-icon.png" /></span>修改</a>
				<a href="/admin/sys/role/doDelete?id=<?php echo $data[$i]['id']; ?>" onclick="return confirm('你确定要删除吗？')" ><span class="icon-img"><img src="/images/delete-icon.png" /></span>删除</a>
			</td>
		</tr>
		<?php } ?>
	</tbody>
...
$(document).ready(function(){
	...
	$('.deleteChooseBtn').click(function(){
		deleteChooseItems('ids','你确定要删除选定项吗？','/admin/sys/role/destroy','true','showDeleteItems');
	});
});
</script>