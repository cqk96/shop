...
<style type="text/css">
	...
	.operationBox div:hover { cursor: pointer;}
	.msg-notice-box {
		padding: 20px;
	}
	.icon-img-box {
		...
		<div class="smart-widget-inner">
			...
			<table class="table table-bordered" id="menuTable">
				...
				<tbody>
					...
					<tr class="<?php echo $i%2==0? 'singular':'dual' ?>"  data-level="<?php echo $data[$i]['level']; ?>" >
						...
						<td class='operationBox'>
							<div onclick="changeText(this, <?php echo $data[$i]['id']; ?>)" class="icon-img-box" ><span class="icon-img"><img src="/images/edit.png" /></span>修改</div>
							<a href="/admin/company/department/users?id=<?php echo $data[$i]['id']; ?>"><span class="icon-img"><img src="/images/eye.png" /></span>查看人员</a>
							<div onclick="createDepartment(this, <?php echo $data[$i]['id']; ?>)" class="icon-img-box" ><span class="icon-img"><img src="/images/plus.png" /></span>增加下级部门</div>
							<div onclick="createParentDepartment(this, <?php echo $data[$i]['id']; ?>)" class="icon-img-box" ><span class="icon-img"><img src="/images/plus.png" /></span>增加上级部门</div>
						</td>
					</tr>
					<?php } ?>
				</tbody>
