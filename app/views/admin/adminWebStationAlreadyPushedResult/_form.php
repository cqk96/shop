<input type='hidden' name='id' value='<?php echo empty($data['id'])? '':$data['id'];  ?>' />
 ...
 <div class='smart-widget-inner'>
	 <ul class='list-group to-do-list sortable-list no-border'>
		...
		<li class='list-group-item' draggable='false'>TIMES<input type='text' name='times' required class='form-control' id='times' value='<?php echo empty($data['times'])? '':$data['times'];  ?>' placeholder='请输入times' /> </li>
