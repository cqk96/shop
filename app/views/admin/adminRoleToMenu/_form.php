...
<li class="list-group-item" draggable="false">
	...
	<label class="checkbox-inline">
	  <input type="checkbox" name="menu_ids[]" id="" value="<?php echo $menus[$i]['id']; ?>" <?php if(!empty($roleMenus) && in_array($menus[$i]['id'], $roleMenus)) echo "checked"; ?> > <?php echo $menus[$i]['name']; ?>
	</label>
	<?php }?>
</li>
<li class="list-group-item" draggable="false">
