...
class AdminDepartmentController extends AdminBaseController
{
	...
	public function index()
	{
		...
		$page_title = '部门管理';
		$menusArr = $this->departmentObj->getAllMenu(1, 1000);
		...
		require_once dirname(__FILE__).'/../../views/admin/company/adminDepartment/index.php';
	...
	public function create()
	{
		...
		// $arr = $this->departmentObj->getAllMenu(1, 1000);

		require_once dirname(__FILE__).'/../../views/admin/company/adminDepartment/_create.php';
	...
	*/
	public function update()
	{
		...
		$id = $_GET['id'];
		$page_title = "修改部门";
		$data = $this->departmentObj->getTopMenu($id);

		require_once dirname(__FILE__).'/../../views/admin/company/adminDepartment/_update.php';
	...
	public function doCreate()
	{
		...
		if(!count($name_is_used)==0){
			header('Refresh: 2;url=/admin/company/departments');
			echo "该部门名已存在";
			return false;
		}
		...
		$obj = new \EloquentModel\Department;
	...
	*/
	public function users()
	{
		...
		try {
			...
			require_once dirname(__FILE__).'/../../views/admin/company/adminDepartment/users.php';
