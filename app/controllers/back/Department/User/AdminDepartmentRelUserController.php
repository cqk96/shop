 ...
 * @version 1.0.0
 */
 namespace VirgoBack\Department\User;
 class AdminDepartmentRelUserController extends AdminBaseController{
	 ...
	 */
	 ...
	 public function doCreate()
	 {
		 ...
		 if($rs){$this->showPage(['添加专区分类成功'],'/admin/departmentRelUsers?page='.$page); }
		 else {$this->showPage(['添加专区分类失败'],'/admin/departmentRelUsers?page='.$page); }
	 }
	 ...
	 public function doUpdate()
	 {
		 ...
		 if($rs){$this->showPage(['修改成功'],'/admin/departmentRelUsers?page='.$page); }
		 else {$this->showPage(['修改失败'],'/admin/departmentRelUsers?page='.$page); }
	 }
	 ...
	 public function doDelete()
	 {
		 ...
		 if($_POST){
			 ...
			 if($rs){$this->showPage(['删除成功'],'/admin/departmentRelUsers');}
			 else {$this->showPage(['删除失败'],'/admin/departmentRelUsers');}
		 }
	 }
 }
 ?>