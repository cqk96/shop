...
use VirgoModel;
class ActivitySignInAndOutModel extends VirgoModel\BaseModel {
	...
	{
		$this->_model = new \Module\Activity\EloquentModel\ActivitySignInAndOut; 
	}
	...
	*/
	public function lists()
	{
		...
		//设置页数跳转地址
		$pageObj->setUrl('/admin/activitySignInAndOuts');
		// 设置分页数据
	...
	* @return 	array
	*/
	public function getUserActivitySignInRecord($uid, $aid)
	{
