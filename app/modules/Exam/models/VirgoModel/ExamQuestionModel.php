...
use VirgoModel;
class ExamQuestionModel extends VirgoModel\BaseModel {
	...
	{
		$this->_model = new \Module\Exam\EloquentModel\ExamQuestion; 
	}
	...
	*/
	public function lists()
	{
		...
		//设置页数跳转地址
		$pageObj->setUrl('/admin/examQuestions');
		// 设置分页数据
	...
	* @return 	array
	*/
	public function getExamQuestionIndex($examId, $index)
	{
		return $this->_model->where("is_deleted", 0)->where("exam_id", $examId)->where("question_index", $index)->first();
	}
