...
<div class="middle-content">
    ...
    <div class="list-content">
        <div class="form-select">
            <form id="searchForm" action="/admin/exams/testLists" class="layui-form">
            ...
            <table class="form-table">
                ...
                <tbody>
                    <?php for ($i=0; $i < count($data); $i++) { ?>
                       <tr>
                            <td title="<?php echo $data[$i]['title'] ?>"><?php echo $this->cutStr($data[$i]['title'], 42); ?></td>
                            <td><img class="table-icon pencil-icon" src="/images/pencil@2x.png" alt=""><a href="/admin/exams/testList/start?id=<?php echo $data[$i]['id']; ?>">开始考试</a></td>
                        </tr> 
                    <?php } ?>
