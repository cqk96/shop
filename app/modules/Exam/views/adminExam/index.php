...
.upload-file-form .layui-form-label {
    display: inline-block;
}
.upload-file-form .layui-form-item {
    width: 86%;
}
.upload-file-form .layui-input-block {
        float: right;
    width: 77%;
    margin-left: inherit;
}
...
<div class="middle-content">
    ...
    <div class="list-content">
        <div class="form-select">
            <form id="searchForm" action="/admin/exams" class="layui-form">
                ...
                <tbody>
                    <?php for ($i=0; $i < count($data); $i++) { ?>
                       <tr>
                            ...
                            <td><img class="table-icon" src="/images/bianji.png" alt=""><a href="/admin/exams/update?id=<?php echo $data[$i]['id']; ?>">编辑</a></td>
                        </tr> 
                    <?php } ?>
...
function notice()
{
    ...
    $(document).ready(function(){
		...
		content += "<form id='fileForm' action='/admin/exam/batchUpload'  method='POST' enctype='multipart/form-data' >";
    ...
    function newTSubject() {
        ...
        layer.open({
            ...
            title: '',
            area : ["500px", "200px"],
            content : '<form class="layui-form upload-file-form"><div class="layui-form-item layui-inline"><span class="layui-form-label" style="">考试题目:</span><div class="layui-input-block">\n' +
